						...
						<div class={style.info}>
							...
							<div class={style.intro}>
								<LocalLabel localizeKey="description">
									...
									may access and use certain information on your device and
									about this site to serve relevant ads or personalized content.
								</LocalLabel>
							</div>
							...
							<div class={style.options}>
								<div
									class={[
										style.option,
										selectedPanelIndex === PANEL_COLLECTED && isExpanded
											? style.expanded
											: ''
									].join(' ')}
								>
									...
									>
										<LocalLabel localizeKey="links.data.description">
											<ul>
												...
												<li>
													Information about other identifiers assigned to the
													device
												</li>
												<li>
								...
								<div
									class={[
										style.option,
										selectedPanelIndex === PANEL_PURPOSE && isExpanded
											? style.expanded
											: ''
									].join(' ')}
								>
										...
										<ul>
											{purposes.map((purposeItem, index) => (
												<li class={style.purposeItem}>
													...
													>
														<PurposesLabel
															localizeKey={`purpose${purposeItem.id}.menu`}
														>
															{purposeItem.name}
														</PurposesLabel>
													</a>
