			...
			>
				...
				<div>
					<LocalLabel localizeKey="message" class={style.title}>
						<h2>A reminder you can control your user privacy preferences</h2>
					</LocalLabel>
					<div class={style.descriptionRow}>
						<LocalLabel localizeKey="description" class={style.message}>
							<span>
								...
								[pixels, tokens and/or beacons] to collect certain data. By
						...
						<LocalLabel localizeKey="privacyPolicy" class={style.message}>
							<span>
								Please visit our Privacy Policy [Link to PP] to learn more about
								how we collect and use data. You can modify your settings at any
								time by clicking [Manage Settings Link].
							</span>
						</LocalLabel>
						<a class={style.modalLink} onClick={this.handleShowConsent}>
							<LocalLabel localizeKey="privacyPolicyButton">Manage Privacy Settings</LocalLabel>
						</a>
					</div>
				</div>
